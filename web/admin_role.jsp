                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><a class="btn btn-danger"  href="RoleServlet?action=delete&id=<%=rol.getId()%>">Delete</a>
                                            <a class="btn btn-primary" href=# data-toggle="modal" data-target="#modalEdit<%=rol.getId()%>" >Update</a>
                                        </td>
                                    </tr>
                                    <%}
                                    }%>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="RoleServlet" method="POST">
                        <label><b>ID</b></label>
                        <input class="form-control" type="text" name="id" value="<%=(role != null) ? role.getId() : ""%>"/>
                        <br>
